...
#define DEFAULT_BUS_TIMING 0x00303D5B

typedef struct
{
    /* Hardware Routing Parameters */
    GPIO_TypeDef *scl_port;      /* e.g., GPIOB */
    GPIO_TypeDef *sda_port;      /* e.g., GPIOB */
    uint32_t scl_pin;            /* e.g., LL_GPIO_PIN_8 or raw position */
    uint32_t sda_pin;            /* e.g., LL_GPIO_PIN_9 or raw position */
    uint8_t alternate_function;  /* e.g., 4U for I2C1 AF4 on STM32G4 */
